...
import styles from "../styles/ChatMessageUser.module.css";
import CsvDisplay from "./CsvDisplay"; // Import CsvDisplay for CSV messages

function ChatMessageUser({ message, userIcon, userInitials }) {
  return (
    <article className={styles.messageContainer}>
      <div className={styles.messageContent}>
        {/* User Avatar */}
        <div className={styles.userAvatar} style={{ backgroundColor: "#eb690b" }}>
          <svg
            width="16"
            height="18"
            viewBox="0 0 16 18"
          ...
          >
            <path
              d="M16 18V16C16 14.9391 15.5786 13.9217 14.8284 13.1716C14.0783 12.4214 13.0609 12 12 12H4C2.93913 12 1.92172 12.4214 1.17157 13.1716C0.421427 13.9217 0 14.9391 0 16V18"
              stroke="#ECECF1"
              strokeWidth="1.5"
              strokeLinecap="round"
            ...
            />
            <path
              d="M8.0001 8C10.2093 8 12.0001 6.20914 12.0001 4C12.0001 1.79086 10.2093 0 8.0001 0C5.79096 0 4.0001 1.79086 4.0001 4C4.0001 6.20914 5.79096 8 8.0001 8Z"
              stroke="#ECECF1"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
